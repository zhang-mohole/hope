...
def make_data(STB_root):
    ...
    for name in name_set:
        ...
        r_coor3d = coor3d - coor3d[:,9,:].reshape(coor3d.shape[0],1,coor3d.shape[2]).repeat(21, axis=1)
...
if __name__ == "__main__":
    stb_root = '/home/zmh/datasets/dataset/hand-pose-STB/' # '/home/tlh-lxy/zmh/data/STB'
    make_data(stb_root)
